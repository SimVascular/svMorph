...
from svmorph.core.deformation import (
    ...
    kelvinlets_stent_edge,
    kelvinlets_truncated_sphere_warp_shrink,
    kelvinlets_truncated_sphere_warp_sculp,
    smin_sdf_capsule_contact_sculp,
    get_affine_laplacian_displacements_inner,
    get_stent_edge_displacements_inner,
    ...
    compute_stent_edge_displacements as get_stent_edge_displacements,
